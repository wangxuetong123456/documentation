...
- **durations**：当前页总耗时(毫秒)
- **image_id**：当前页图片id 。受URL参数影响，\_<u>当URL参数image_output_type=default且get_image=page/both时返回，</u>\_详情见[快速启动-URL参数说明](/xparse/extract-quickstart)。
...
<Tip>
  **另外您也可以在**[**API**](/api-reference/endpoint/extract)**中查看Response说明。**
</Tip>
