...
本教程基于如下pdf示例文件，您可点击下载或使用该url：
https://web-api.textin.com/open/image/download?filename=a2bd40607faa4be7ba975d41c96b9a47

## 上传pdf文件，获取解析结果

参考[快速启动](/xparse/parse-quickstart)，上传pdf文件，获取解析结果。

本次示例文件解析结果如下（为方便展示，此处只解析一页，仅列出部分核心字段）：
...
<img src="/images/parse-getpos-generated.png" />

可以看到，Textin xParse针对复杂布局的文档，能够精准识别并快速还原坐标，方便您将解析结果与原文件进行对比校注，快去[上手体验](https://www.textin.com/console/recognition/robot_markdown?service=pdf_to_markdown)吧，登录就送大量免费额度！



## 前端开源项目

此外，我们开源了web前端项目[xparse-frontend](https://github.com/intsig-textin/xparse-frontend/)，该项目包含跟我们[在线web平台](https://www.textin.com/console/recognition/robot_markdown?service=pdf_to_markdown)效果一致的全套前端代码。一键上手，开箱即用，欢迎体验！
