...
在TextIn xParse文档抽取API中，抽取结果的输出是JSON格式；如果您的系统或任务中更常见的文件格式是Excel格式，则可以参考以下教程，将抽取结果保存为Excel文件。

这里提供一个简单的实现方式：

## 如何获取表格

参考[**快速启动**](/xparse/extract-quickstart)中的示例代码和返回结果，您可以参考以下代码将抽取结果保存为Excel文件。
