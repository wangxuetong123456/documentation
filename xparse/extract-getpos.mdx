...
参考[**快速启动**](/xparse/extract-quickstart)中的返回结果示例(prompt模式返回节选部分)，文档抽取API的返回结果中包含了以下坐标关键信息：
...
![Annotated Extract Result Pn](https://static.textin.com/docs/images/annotated_extract_result.webp)
