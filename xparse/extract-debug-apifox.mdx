---
title: "Apifox调试教程"
description: "通过Apifox快速调试文档抽取API"
---
...
![点击导入按钮](/images/extract-debug-apifox-1.webp)

### 步骤3：选择导入方式

1. 在弹出的导入窗口中，将复制的curl命令粘贴到文本框中

![选择cURL导入](/images/extract-debug-apifox-2.webp)
...
![确认导入](/images/extract-debug-apifox-3.webp)
...
![修改API Key](/images/extract-debug-apifox-4.webp)
...
![修改JSON Body](/images/extract-debug-apifox-5.webp)
...
![发送请求](/images/extract-debug-apifox-6.webp)
