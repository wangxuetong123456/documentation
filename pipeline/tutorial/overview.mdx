---
title: "导览"
description: "在动手前确认准备工作，并快速跳转到合适的 xParse ETL 实战指南。"
---

<Tip>
  如果您是首次接触 xParse ETL，建议先完成“预备条件”中的文档，再开始 Agent 或 RAG 的实战练习。
</Tip>
...
**您也可以直接上手实战教程，通过实践了解 xParse ETL 的实际应用场景和使用方法。**

## 推荐阅读

<CardGroup cols={2}>
  <Card
    title="Agent 实战：xParse ETL + LangChain"
    icon="robot"
    href="/pipeline/tutorial/agent-tutorial"
  >
    结合 Pipeline 与 LangChain Agent，演示客服、营销、教育等场景下的自动解析与检索回答。
  </Card>
  <Card
