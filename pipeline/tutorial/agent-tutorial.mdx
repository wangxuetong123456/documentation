---
title: "客服、营销、教育助手 Agent：自动解析与检索回答"
description: "结合 xParse 与 LangChain Agent，实现一体化的文档解析、知识入库与智能问答自动化流程。"
---
...
SCENARIO_CONFIGS = {
    ...
    "marketing": {"stages": [{"type": "chunk", "config": {"strategy": "semantic", "max_characters": 1200}}]},
    "education": {"stages": [{"type": "chunk", "config": {"include_orig_elements": True}}], "destination": {"collection_name": "course_docs"}}
}
