---
title: "实战：构建多场景 RAG 应用"
description: "使用 xParse ETL 构建完整的 RAG 应用，包含企业知识库、法律文档检索等实际场景"
---

<Tip>
  本教程将带您了解如何使用 xParse ETL 构建完整的 RAG（检索增强生成）应用。我们将通过三个实际场景，展示从文档处理到向量检索的完整流程。
</Tip>
...
xParse ETL 专注于解决第一步和第二步，为您提供端到端的文档处理能力。
...
Milvus 是一个开源的向量数据库，xParse ETL 会自动创建集合和索引：
